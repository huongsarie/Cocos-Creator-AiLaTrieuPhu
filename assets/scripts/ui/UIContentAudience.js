...
var UIContentAudience=cc.Class({
    ...
    init:function(answerTrue,isOps){
    ...
    ,setTwoOptions:function(ans1,ans2){ //ans1===true
        this.is2Option=true;
        this.option1=ans1;
        this.option2=ans2;
    }
    ...
    ,effect:function(sprite,label,percent,speed){
        if(percent===-1){
            sprite.node.active=false;
            label.node.active=false;
        }else
        if(sprite.node.height+speed<=percent*this.space){
            this.changWithPercent(sprite,label,speed);
        }
        
    }
    ,changWithPercent:function(sprite,label,speed){
    ...
    ,getBarOfTrueAnswer:function(number){
        var bar=null;
        switch (number) {

...
var ArchivementPath=[
'atp__achievement_bai_khong_nan.png'
,'atp__achievement_ban_la_trieu_phu.png'
,'atp__achievement_bat_kha_chien_bai.png'
,'atp__achievement_bat_nhip_chien_thang.png'
,'atp__achievement_buc_toc_vuot_len.png'
,'atp__achievement_cham_tay_chien_thang.png'
,'atp__achievement_chien_thang_mo_hang.png'
,'atp__achievement_dai_kien_tuong.png'
,'atp__achievement_doc_co_cau_bai.png'
,'atp__achievement_everest.png'
,'atp__achievement_fansipan.png'
,'atp__achievement_hat_trick.png'
,'atp__achievement_huyen_thoai.png'
,'atp__achievement_keo_ngot.png'
,'atp__achievement_khoi_dau_manh_me.png'
,'atp__achievement_khoi_dong_thanh_cong.png'
,'atp__achievement_kho_bau_kien_thuc.png'
,'atp__achievement_kien_tuong.png'
,'atp__achievement_ky_phung_dich_thu.png'
,'atp__achievement_nha_hien_triet.png'
,'atp__achievement_olympus.png'
,'atp__achievement_than_rua.png'
,'atp__achievement_than_toc_tao_bao.png'
,'atp__achievement_thap_toan_thap_my.png'
,'atp__achievement_tho_san_chien_thang.png'
,'atp__achievement_vua_cam_hoa.png'
,'atp__achievement_yeu_hoa_binh.png' 
,'atp__achievement_item_default.png'
];
...
const P_PATH='resources/textures/archivement/';
var ArchivementPrefab=cc.Class({
    ...
    ,changeSprite:function(number){
        let path=P_PATH+ArchivementPath[number];

...
const AnswerState= require('State').AnswerState;
const HelpState=require('State').HelpState;
var Game_HelpMenu=cc.Class({
    ...
    do5050:function(){
        ...
        while(ans2===this.player_answer || ans1=== this.player_answer || ans1===ans2 
        || ans1===AnswerState.EMPTY || ans2===AnswerState.EMPTY){
    ...
    ,doShowPanelOppotunities:function(isCall){
        ...
        if(isCall===true){
            ...
            var cFunc=cc.callFunc(function(){
                if(this.gameComponent.getCurrentQuestion()===this.btn5050.phuthuoc)
                this.help_component.clickAudience(true);
            else
                this.help_component.clickAudience(false);
    ...
    ,isOppotunitiesClickable: function(){
        return this.isClick;
    }
    ,setOppotunitiesClickable: function(isClick){
        this.isClick= isClick;
    }
    ,doDisallowClickedAllHelp:function(){
    ...
    ,doAllowClickedAllHelp:function(){

...
const UserData=StoreData.UserData;
var UserKey=require('UserInforKey').UserInforKey;
var lastLevel=-1;
var isStopHelp=false;
var ls=cc.sys.localStorage;
const State=require('State');
const ArMax=require('ArchivementPrefab').ArchivementMax;
...
var GameOver=cc.Class({
    ...
    init:function(lastlevel,isStopHelp){
        this.labelLastLevel.string="";
        if(isStopHelp===true){// giu nguyên tiền thưởng đối vs lastlevel-1
        ...
        }else{// tiền thưởng trở về mốc thấp gần nhất
    ...
    ,doSaveMoney:function(moneybonus){
    ...
    ,clickBtnSingle: function(){
        cc.director.loadScene('LoadGameScene_Login');
    }
    ,clickBtnThachDau: function(){
